...
declare const DuplicateCreateReviewSchemaDefinition: z.ZodObject<{
    ...
    newsCandidate: z.ZodOptional<z.ZodNullable<z.ZodArray<z.ZodType<{
        externalId?: string | null | undefined;
        id: number;
        reason: string[];
        score: number;
 ...
 * @ownerSourceFile src/main/kotlin/vc/aventure/domain/model/search/DuplicateCreateReview.kt
 */
