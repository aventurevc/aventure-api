 ...
 * @endpoint POST /v1/entities/{entityId}/repositories/sync
 * @endpoint POST /v1/people/{personId}/repositories/sync
 * @usedBySchema PageGithubRepoSchema
 * @contractShape github.repo
 * @contractRole canonical
 * @ownerSourceFile src/main/kotlin/vc/aventure/domain/model/github/GithubRepo.kt
 */
