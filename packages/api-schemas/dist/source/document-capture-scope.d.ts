 ...
 */
export declare const SourceDocumentCaptureScopeSchema: z.ZodEnum<{
    page: "page";
    selection: "selection";
    supplied: "supplied";
    viewport: "viewport";
}>;
export type SourceDocumentCaptureScope = z.infer<typeof SourceDocumentCaptureScopeSchema>;
//# sourceMappingURL=document-capture-scope.d.ts.map