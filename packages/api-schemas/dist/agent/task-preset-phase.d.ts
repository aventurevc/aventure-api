 ...
 */
export declare const AgentTaskPresetPhaseSchema: z.ZodEnum<{
    FINAL: "FINAL";
    PRIMARY: "PRIMARY";
}>;
export type AgentTaskPresetPhase = z.infer<typeof AgentTaskPresetPhaseSchema>;
//# sourceMappingURL=task-preset-phase.d.ts.map